...
n_tot_exp = len(activation_arr)*len(batch_size_arr)*len(lr_arr)*len(dropout_arr)*len(bias_arr)*len(F1_D_arr)*len(top_number_arr)
count_exp = 0
acc_max = 0
dir = './All_exp_TL/'
acc_arr = []
                    ...
                    for bias in bias_arr:
                        for F1_D in F1_D_arr:
                            ...
                            for top_number in top_number_arr:
                                ...
                                path = transfer_learning+"_top"+str(top_number)+"_"+activation+'_dropout='+str(dropout)+'_F1='+str(F1)+'_D='+str(D)+'_lr='+str(lr)+'_bs='+str(batch_size)+'_bias='+str(bias)+'_'+str(chans)+'chans/'
